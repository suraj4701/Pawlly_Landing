...
class CustomReporter {
    ...
    async onEnd(result) {
        ...
        console.log(`\n--- Test Summary ---`);
        console.log(`Project: Pawlly Landing Page`);
    ...
    async sendReportEmail(overallStatus, passedCount, failedCount) {
        ...
        let emailHtmlBody = `
            <p>Dear Team,</p>
            <p>Here is the automated Playwright test report summary for <strong>Pawlly Landing Page</strong> as of ${new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}.</p>
            <hr>
            <h2>Test Summary</h2>
